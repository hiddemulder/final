...
var base = Rebase.createClass({
  apiKey: "AIzaSyDl-YSz3f4Uo6ze3mDNF6eZkIoCySPSbMQ",   // replace with your Firebase application's API key
  databaseURL: "https://my-final-project-16a26.firebaseio.com/", // replace with your Firebase application's database URL
})
    ...
    if (this.state.currentView === 'map') {
      return (
        ...
        <Gmaps width={'100%'}
           ...
           lng={'-87.6285782'}
           zoom={11}
           loadingMessage={'Map of Cinemas'}
           params={{v: '3.exp', key: 'AIzaSyDl-YSz3f4Uo6ze3mDNF6eZkIoCySPSbMQ'}}>
